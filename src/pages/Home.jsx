	...
	return (
		...
		<NavBar/>
            ...
            <h1 className="text-4xl lg:text-6xl font-extrabold text-gray-900">
              Your Gateway to
              <span className="block text-indigo-600">Academic Excellence</span>
            </h1>
            <p className="text-lg text-gray-600">
              ...
              Elevate your learning journey with us.
				...
				<div className="  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-20 border-t pt-20   ">
					{/** Idea Upload  */}
					<div className="space-y-4 py-10 lg:col-span-2 order-2 md:order-1 border-t my-10 md:my-0 md:border-none ">
					...
					{/** File upload section */}
					<div className=" border rounded-3xl p-5 order-1 md:order-2">
						<h2 className=" p-4 text-xl font-bold">Upload File</h2>
