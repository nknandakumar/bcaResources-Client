	 ...
	 <Chatbot/>
      ...
      <section className="my-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:mx-auto lg:px-32">
        {notes?.length === 0 ? (
          ...
          notes?.map((note) => (
            <div key={note.id} className="flex flex-col p-5 justify-center border-l-8 border border-[#4a6da1] rounded-lg w-full lg:max-w-sm">
              <h1 className="text-2xl lg:text-2xl mt-2 font-semibold text-left mb-4">{note.note_title}</h1>
